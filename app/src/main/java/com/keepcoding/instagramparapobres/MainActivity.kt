...
class MainActivity : AppCompatActivity(), GalleryRecyclerAdapter.ListImagesClickListener, DIAware {
    ...
    companion object {
        const val INTENT_LIST_KEY = "imageList"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = GalleryRecyclerAdapter(this)
    ...
    private fun showImageList(image: Image) {
        val imageList = Intent(this, DetailActivity::class.java)
        imageList.putExtra(INTENT_LIST_KEY, image)
        startActivity(imageList)
    }

    override fun listImagesClicked(image: Image) {
        showImageList(image)
    }
